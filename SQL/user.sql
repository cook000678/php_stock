...
CREATE TABLE `member` (
  ...
  `level` enum('admin','general','','') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'general'
...
(1, 'haohao', 'hao860211', 'admin'),
(2, 'rrrr', 'rrrr', 'admin'),
(3, 'xxxx', 'xxxx', 'general'),
(4, 'ppppp', 'ppppqqq', 'general'),
(5, 'qqqq', 'qqqq', 'general'),
(6, 'qqqq', 'qqqq', 'general');
